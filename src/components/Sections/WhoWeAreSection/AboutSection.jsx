  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 py-8 md:py-12 bg-light">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-center items-start md:items-center">
        <div className="hidden md:block h-[270px] border-l-4 border-[#FF0C10] mr-10"></div>

        <div className="text-gray text-lg sm:text-xl leading-normal md:text-[22px] md:text-left text-center">
          <p>
            <strong> SixthSense Leadership</strong> is a human capital
            development and consulting company empowering leaders to transform
            organizations for sustainable growth through cutting-edge leadership
            solutions.
            <br /> <br />
