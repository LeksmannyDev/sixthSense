...
const WhatBanner = () => {
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 py-8 md:py-15 bg-light">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-center items-start md:items-center">
        ...
        <div className="text-gray text-lg sm:text-xl lg:text-left text-center">
          <p className="">
            ...
            growth through innovative interventions.
          </p>
        </div>
      </div>
    </div>
