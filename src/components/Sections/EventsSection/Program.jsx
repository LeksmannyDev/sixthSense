  ...
  return (
    <section className="relative w-full h-[450px] sm:h-[450px] md:h-[500px] lg:h-[550px] xl:h-[600px]">
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 sm:px-6 mx-auto max-w-6xl">
          <h2 className="text-3xl sm:text-4xl md:text-4xl font-medium text-red mb-4 sm:mb-6">
            Program
          </h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 md:gap-8 w-full max-w-md sm:max-w-xl md:max-w-6xl">
